<template>
    ...
    <ui-gauge-water-tank v-else-if="props.gtype === 'gauge-water-tank'" :id="id" :props="props" :value="value" />
...
import UIGaugeWaterTank from './types/UIGaugeWaterTank.vue'

export default {
    name: 'DBUIGauge',
    components: {
        'ui-gauge-battery': UIGaugeBattery,
        'ui-gauge-water-tank': UIGaugeWaterTank,
