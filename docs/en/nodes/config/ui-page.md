...
A page holds any number of [groups](./ui-group), arranged by its [Layout](../../layouts/). If you're coming from Dashboard 1.0, a page is the equivalent of a `ui-tab` — to render your groups as switchable tabs, use the [Tabs](../../layouts/types/tabs) layout.
